 ...
 * $Revision: 33980 $
 * $Author: rjongbloed $
 * $Date: 2015-09-05 09:57:55 +0100 (Sat, 05 Sep 2015) $
 */
...
class PSSLCipherContext : public PObject
{
  ...
  private:
    PSSLCipherContext(const PSSLCipherContext &) : PObject() { }
...
class PSHA1Context : public PObject
{
  ...
  private:
    PSHA1Context(const PSHA1Context &) : PObject() { }
...
class PSSLContext : public PObject
{
  ...
  private:
    PSSLContext(const PSSLContext &) : PObject() { }

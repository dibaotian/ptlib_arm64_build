...
#define PXMLRPC_UNSIGNEDLONG(base, type, variable) \
        PXMLRPC_VARIABLE(base, type, variable, "unsigned long long")


#define PXMLRPC_UNSIGNEDLONG_INIT(base, type, variable, init) \
        PXMLRPC_VARIABLE_INIT(base, type, variable, "unsigned long long", init)
